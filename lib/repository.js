 ...
 */
async function getTagHead(tagName, execaOpts, repoType = "git") {
  try {
 ...
 */
async function getTags(execaOpts, repoType = "git") {
 ...
 */
async function isRefInHistory(ref, execaOpts, repoType = "git") {
  try {
 ...
 * @param {Object} [execaOpts] Options to pass to `execa`.
 */
async function fetch(repositoryUrl, execaOpts, repoType = "git") {
  try {
 ...
 */
function getGitHead(execaOpts, repoType = "git") {
 ...
 */
async function repoUrl(execaOpts, repoType = "git") {
  try {
 ...
 */
async function isGitRepo(execaOpts, repoType = "git") {
  try {
 ...
 */
async function verifyAuth(repositoryUrl, branch, execaOpts, repoType = "git") {
  try {
 ...
 */
async function tag(tagName, execaOpts, repoType = "git") {
 ...
 */
async function push(repositoryUrl, execaOpts, repoType = "git") {
 ...
 */
async function verifyTagName(tagName, execaOpts, repoType = "git") {
  try {
 ...
 */
async function isBranchUpToDate(branch, execaOpts, repoType = "git") {
